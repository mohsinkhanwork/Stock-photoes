...
<div class="content-wrapper">
    ...
    <div class="card-body">
        ...
        <div class="form-group" style="width: 100%;display: flex;">
            <label style="width: 20%;"> Foto-ID: </label>
        ...
        <form method="POST" action="{{ route('admin.store.version.photos') }}" enctype="multipart/form-data">
            ...
            <input type="hidden" name="category_name_1" value="{{ $category_name_1 }}">
            <input type="hidden" name="subcategory_1" value="{{ $subcategory_1 }}">
            <input type="hidden" name="color_create_version" value="{{ $color_create_version }}">
            {{--  <input type="hidden" name="title" value="{{ $photo_title }}">  --}}
        ...
        <div class="form-group" style="width: 100%;display: flex;">
            <label for="image" class="col-form-label" style="width: 20%;"> Foto <code>*</code>
            </label>
            <div style="width: 30%;">
                <label for="inputTag1">
        ...
        <div class="card-footer" style="text-align: right;padding-right: 0;">
            <a href="{{ url('admin/edit/photos/' . $category_name_1 . '/' . $photo_id . '/#' . $color ) }}"
