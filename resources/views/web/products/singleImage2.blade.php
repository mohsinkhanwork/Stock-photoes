...
<style>
    ...
    cursor: initial;
    max-height: 90vh; // This maintains the aspect ratio by adjusting the width automatically
  ...
  <div class="row" style="margin: 28px 28px 30px 28px;">
     <div class="col-md-7 SingleImage" style="background: #E8EAED;">
                ...
                <a href="{{ route('single.Image2', ['category_id' => $image->category_id, 'image_id' => $nextID, 'categoryId' => $categoryId]) }}"
        ...
        <div class="expand-img" role="button" >
           ...
           {{-- Next Page Link --}}
            ...
            <a href="{{ route('single.Image2', ['category_id' => $image->category_id, 'image_id' => $previousID, 'categoryId' => $categoryId]) }}"
