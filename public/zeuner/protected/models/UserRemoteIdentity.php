...
/**
 * This is the model class for table "usr_user_remote_identities".
 *
 * The followings are the available columns in table 'usr_user_remote_identities':
 * @property integer $id
...
class UserRemoteIdentity extends CActiveRecord
{
    ...
    {
        return 'usr_user_remote_identities';
    }
