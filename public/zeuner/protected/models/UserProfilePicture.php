...
/**
 * This is the model class for table "usr_user_profile_pictures".
 *
 * The followings are the available columns in table 'usr_user_profile_pictures':
 * @property integer $id
...
class UserProfilePicture extends CActiveRecord
{
    ...
    {
        return 'usr_user_profile_pictures';
    }
