...
/**
 * This is the model class for table "usr_user_login_attempts".
 *
 * The followings are the available columns in table 'usr_user_login_attempts':
 * @property integer $id
...
class UserLoginAttempt extends CActiveRecord
{
    ...
    {
        return 'usr_user_login_attempts';
    }
