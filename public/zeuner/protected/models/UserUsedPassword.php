...
/**
 * This is the model class for table "usr_user_used_passwords".
 *
 * The followings are the available columns in table 'usr_user_used_passwords':
 * @property integer $id
...
class UserUsedPassword extends CActiveRecord
{
    ...
    {
        return 'usr_user_used_passwords';
    }
